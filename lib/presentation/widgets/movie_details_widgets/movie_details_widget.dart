...
import 'package:the_scene/presentation/widgets/movie_details_widgets/recommendation_widget.dart';
        ...
        switch (state.movieDetailsState) {
          ...
          case RequestState.error:
            return SizedBox(
              ...
              child: Center(
                child: Text(
                  state.movieDetailsMessageError,
                  style: const TextStyle(
                    color: Colors.amber,
                  ),
                ),
